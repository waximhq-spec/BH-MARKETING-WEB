      ...
      <div className="container max-w-5xl mx-auto px-6">
        <header className="mb-20 border-b border-white/10 pb-12">
          <h1 className="font-black text-5xl md:text-7xl tracking-tighter leading-none mb-6">
            THE <span className="text-[#9A0E1F]">JOURNAL.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 gap-12">
          {blogPosts.map((post) => (
            <article key={post.slug} className="group border border-white/5 bg-white/[0.02] p-8 md:p-12 hover:bg-white/[0.04] transition-colors duration-500">
              <div className="flex flex-wrap items-center gap-4 text-xs font-mono tracking-widest text-[#9A0E1F] uppercase mb-6 font-bold">
              ...
              <Link href={`/blog/${post.slug}`}>
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 group-hover:text-[#9A0E1F] transition-colors duration-300">
                  {post.title}
                </h2>
              </Link>
              ...
              <Link 
                href={`/blog/${post.slug}`}
                className="inline-flex items-center gap-4 text-sm font-mono tracking-[0.2em] uppercase font-bold text-white hover:text-[#9A0E1F] transition-colors"
              >
