    ...
    <main className="w-full relative z-10 mx-auto bg-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
          {[
            ...
            <motion.div
              ...
              className="group relative flex flex-col p-8 md:p-10 rounded-[24px] bg-[#1a0505]/40 border border-white/5 backdrop-blur-xl overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-white/10 hover:shadow-[0_0_40px_rgba(217, 22, 22,0.15)] cursor-none"
            >
      ...
      <section className="relative w-full py-32 px-6 md:px-16 flex flex-col items-center z-20">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="w-full max-w-6xl aspect-[4/3] md:aspect-[21/9] rounded-[24px] bg-[#1a0505]/40 border border-white/5 backdrop-blur-md flex items-center justify-center group overflow-hidden relative cursor-none hover:border-white/10 hover:shadow-[0_0_50px_rgba(217, 22, 22,0.1)] transition-all duration-700"
        >
      ...
      <section className="relative w-full py-32 px-6 pb-48 flex justify-center z-20">
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="w-full max-w-3xl rounded-[32px] p-12 md:p-16 bg-[#1a0505]/50 border border-white/5 backdrop-blur-2xl relative overflow-hidden flex flex-col items-center text-center shadow-[0_0_80px_rgba(217, 22, 22,0.05)]"
        >
