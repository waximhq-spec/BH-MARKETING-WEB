    ...
    <main className="w-full relative z-10 mx-auto">
      ...
      <section className="relative w-full min-h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-[#0a0a0a] pt-[60px] sm:pt-[80px] pb-16 sm:pb-24">
        ...
        <div className="z-20 w-full px-4 sm:px-6 md:px-12 lg:px-16 flex flex-col items-center justify-center text-center">
          ...
          {/* Availability Bar */}
          <div className="mb-10 inline-flex items-center gap-3 px-6 py-2 border border-white/10 bg-transparent rounded-none">
            <span className="w-2 h-2 rounded-full bg-green-500 relative"></span>
            <span className="text-[10px] md:text-xs font-medium tracking-[0.2em] text-white/60 uppercase">
              AVAILABLE — Q2 2026 <span className="mx-2">|</span> LIMITED SLOTS
            </span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center w-full mb-10">
            <AnimatedText 
              ...
              className="text-[clamp(2.5rem,7vw,8rem)] leading-[1.1] font-extrabold tracking-[-0.02em] uppercase text-white text-center" 
            />
          </div>
          
          {/* Dynamic Slogan */}
          <div className="mb-8 text-xl sm:text-3xl md:text-[2.5rem] font-normal tracking-tight text-white flex flex-wrap items-center justify-center gap-2">
            <span>We make</span>
          ...
          {/* Short Description */}
          <div className="mb-14 text-sm sm:text-base md:text-lg text-white/50 max-w-2xl mx-auto font-light leading-relaxed tracking-wide px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full px-4 sm:px-0">
            <button className="w-full sm:w-auto min-w-[220px] px-8 py-4 bg-white text-black font-semibold rounded-none hover:bg-white/90 transition-colors flex items-center justify-center gap-3 tracking-[0.15em] text-[10px] sm:text-xs uppercase">
              Start Your Project <span className="text-lg leading-none">→</span>
            </button>
            <button className="w-full sm:w-auto min-w-[220px] px-8 py-4 bg-transparent border border-white/20 text-white font-semibold rounded-none hover:border-white transition-colors flex items-center justify-center gap-3 tracking-[0.15em] text-[10px] sm:text-xs uppercase">
